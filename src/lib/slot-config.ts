...
export const SYMBOLS: Record<SymbolId, {
  ...
  SEVEN: { id: 'SEVEN', icon: SevenIcon, payout: { 3: 100, 4: 500, 5: 2000, 6: 5000 }, name: 'Lucky Seven' },
  DIAMOND: { id: 'DIAMOND', icon: DiamondIcon, payout: { 3: 50, 4: 200, 5: 750, 6: 1500 }, name: 'Diamond' },
  BELL: { id: 'BELL', icon: BellIcon, payout: { 3: 20, 4: 100, 5: 400, 6: 800 }, name: 'Golden Bell' },
  BAR: { id: 'BAR', icon: BarIcon, payout: { 3: 10, 4: 50, 5: 200, 6: 400 }, name: 'BAR' },
  CHERRY: { id: 'CHERRY', icon: CherryIcon, payout: { 2: 5, 3: 10, 4: 25, 5: 100, 6: 200 }, name: 'Cherry' },
  LEMON: { id: 'LEMON', icon: LemonIcon, payout: { 3: 5, 4: 20, 5: 75, 6: 150 }, name: 'Lemon' },
};
